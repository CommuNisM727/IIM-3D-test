...
C REFERENCES              NONE
C ********************************************************************
      INTEGER LPEROD, MPEROD, NPEROD, L, M, N, LD, IERROR
Cf2py intent(in) LPEROD, MPEROD, NPEROD, L, M, N
      REAL*8 C1, C2, A, B, C
      REAL*8 F, W
Cf2py intent(in) C1, C2, A, B, C
...
C
  ...
  122 CONTINUE
     ...
     1                   WX,WY,C1,C2,BB)
      INTEGER LP, L, MP, M, N
Cf2py intent(in) LP, L, MP, M, N
      REAL*8 C1, C2, A, B, C, F, XRT, YRT, T, D, WX, WY, BB
Cf2py intent(in) C1, C2, B, T, D, WX, WY, BB
Cf2py intent(inout) F, XRT, YRT
      DIMENSION       A(*)       ,B(*)       ,C(*)       ,
